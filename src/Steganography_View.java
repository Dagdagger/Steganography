...
public class Steganography_View extends JFrame
{
	...
	public Steganography_View(String name)
	{
		...
		send = new JMenuItem("Send"); send.setMnemonic('S'); file.add(send);
		file.addSeparator();
	...
	public JMenuItem	getSend()		{ return send;				}
	
	public JMenuItem	getReceive()	{ return receive; }
	/*
	...
	public JScrollBar getScroll2() {
		return scroll2;
	}

	public void setScroll2(JScrollBar scroll2) {
